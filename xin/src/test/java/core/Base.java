...
public class Base {
    ...
    public void input(String xpath, String in, WebDriver wr) {
...
//        WebElement webElement = wr.findElement(By.xpath(xpath));
    ...
    public void xiaJi(String name, String zaiyao, WebDriver webDriver) {
     ...
     * @param name 登陆用户名
     */
    public void shenPi(String name) {
     ...
     * @param name 登陆用户名
     */
    public void work(String name, WebDriver wr) throws InterruptedException {
     ...
     *               并且输入摘要
     */
    public void yesorno(String string, WebDriver wr) {
    ...
    public void logIn(String name, WebDriver wr) throws InterruptedException {
        input(Login.LOGIN_NAME, name, wr);
        input(Login.LOGIN_PASSWORD, "0", wr);
...
//        webElement.click();
    ...
    public void Switch(String xpatch, WebDriver wr) {
        wr.switchTo().defaultContent();
        wr.switchTo().frame(xpatch);
    }

    public void DoubleClick(String xpatch, WebDriver wr) {
     ...
     * @param wr
     */
    public void select(String Xpatch, WebDriver wr) {
     ...
     */
    public void alert(String string, WebDriver wr) {
